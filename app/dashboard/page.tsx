...
export default function DashboardPage() {
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-6 sm:px-6 sm:py-10">
      {/* Header bar */}
      <div className="mb-6 sm:mb-10 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between animate-fade-up">
        <div>
      ...
      {isLoading ? (
        ...
        <div className="rounded-2xl bg-[var(--card)] py-20 text-center animate-fade-up delay-200">
