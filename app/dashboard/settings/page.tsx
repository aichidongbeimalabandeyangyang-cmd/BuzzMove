...
export default function SettingsPage() {
  ...
  return (
    <div className="flex w-full flex-1 flex-col">
      {/* Settings body — design: gap 24, padding [24,20,12,20] */}
      <div className="flex flex-1 flex-col gap-6 px-5 pt-6 pb-3">
        {/* ACCOUNT section — design: gap 8, label 12px 600 letterSpacing 1 */}
        <div className="flex flex-col gap-2">
          <p className="text-xs font-semibold tracking-[1px] text-[#6B6B70]">ACCOUNT</p>
          {/* Card — design: cornerRadius 16, fill #16161A */}
          <div className="overflow-hidden rounded-2xl bg-[#16161A]">
            {/* Edit Profile — design: user icon 20px #9898A4, gap 12, padding [14,16] */}
            ...
            {/* Notifications — design: bell icon 20px #9898A4 */}
            <Link href="#" className="flex items-center gap-3 px-4 py-3.5 transition-colors hover:bg-[var(--secondary)]">
              <svg className="h-5 w-5 text-[#9898A4]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
            ...
            {/* Privacy — design: shield icon 20px #9898A4 */}
            <Link href="#" className="flex items-center gap-3 px-4 py-3.5 transition-colors hover:bg-[var(--secondary)]">
              <svg className="h-5 w-5 text-[#9898A4]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="overflow-hidden rounded-2xl bg-[#16161A]">
            {/* Terms — design: file-text icon 20px #9898A4 */}
            ...
            {/* Privacy — design: lock icon 20px #9898A4 */}
            ...
            {/* Refund — design: rotate-ccw icon 20px #9898A4 */}
        ...
        {/* Version — design: 12px normal #4A4A50 */}
