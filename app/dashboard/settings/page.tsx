        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="overflow-hidden rounded-2xl bg-[#16161A]">
            <Link href="#" className="flex items-center gap-3 px-4 py-3.5 transition-colors hover:bg-[var(--secondary)]">
              ...
              <span className="flex-1 text-[15px] font-medium text-[var(--foreground)]">Edit Profile</span>
            ...
            <Link href="#" className="flex items-center gap-3 px-4 py-3.5 transition-colors hover:bg-[var(--secondary)]">
              ...
              <span className="flex-1 text-[15px] font-medium text-[var(--foreground)]">Notifications</span>
              <svg className="h-4 w-4 text-[#6B6B70]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
              </svg>
            </Link>
            <Link href="#" className="flex items-center gap-3 px-4 py-3.5 transition-colors hover:bg-[var(--secondary)]">
              ...
              <span className="flex-1 text-[15px] font-medium text-[var(--foreground)]">Privacy & Security</span>
              <svg className="h-4 w-4 text-[#6B6B70]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
              </svg>
            </Link>
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="overflow-hidden rounded-2xl bg-[#16161A]">
            <Link href="/terms" className="flex items-center gap-3 px-4 py-3.5 transition-colors hover:bg-[var(--secondary)]">
              ...
              <span className="flex-1 text-[15px] font-medium text-[var(--foreground)]">Terms of Service</span>
              <svg className="h-4 w-4 text-[#6B6B70]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
              </svg>
            </Link>
            <Link href="/privacy" className="flex items-center gap-3 px-4 py-3.5 transition-colors hover:bg-[var(--secondary)]">
              ...
              <span className="flex-1 text-[15px] font-medium text-[var(--foreground)]">Privacy Policy</span>
              <svg className="h-4 w-4 text-[#6B6B70]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
              </svg>
            </Link>
            <Link href="/refund-policy" className="flex items-center gap-3 px-4 py-3.5 transition-colors hover:bg-[var(--secondary)]">
              ...
              <span className="flex-1 text-[15px] font-medium text-[var(--foreground)]">Refund Policy</span>
              <svg className="h-4 w-4 text-[#6B6B70]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
              </svg>
            </Link>
