...
export const metadata: Metadata = {
  ...
  description: "BuzzMove Privacy Policy. Learn how we collect, use, and protect your data when you use our AI video generation service.",
  alternates: { canonical: "https://buzzmove.me/privacy" },
};
