    ...
    <div className="relative mx-auto flex min-h-[calc(100vh-3.5rem)] max-w-md flex-col px-4 py-4 sm:py-6">
      ...
      <div className="relative mb-4 animate-fade-up">
        ...
        >
          ...
          <div className="absolute top-3 left-3">
            <span className="rounded-full bg-black/40 backdrop-blur-sm px-2.5 py-0.5 text-[11px] font-medium text-white/80">
      ...
      <div className="mt-auto pt-4 flex items-center justify-center gap-4 animate-fade-up delay-300">
        <div className="flex items-center gap-1 text-[11px] text-[var(--muted-foreground)]">
          <svg className="h-3 w-3 text-[var(--primary)]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
