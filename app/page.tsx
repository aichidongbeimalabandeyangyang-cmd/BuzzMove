...
export default function HomePage() {
  ...
  if (imageUrl && imagePreview) {
    return (
      <div className="relative flex flex-1 flex-col items-center justify-center px-4 py-6 sm:py-8">
    ...
    return (
      <div className="relative flex flex-1 flex-col items-center justify-center px-4 py-6 sm:py-8">
        ...
        <div className="relative w-full max-w-lg">
          ...
          {uploadError && (
            <div role="alert" className="mt-4 rounded-xl bg-[var(--destructive-10)] px-4 py-3 text-center text-sm text-[var(--destructive)] animate-fade-up">
              {uploadError}
            </div>
          )}
          ...
          <button
            ...
            className="mt-5 flex w-full items-center justify-center gap-2 rounded-xl py-3 text-sm text-[var(--muted-foreground)] transition-colors hover:text-[var(--foreground)] hover:bg-[var(--secondary)] active:scale-[0.98]"
          >
    ...
    <div className="relative mx-auto flex flex-1 max-w-md flex-col px-4 py-4 sm:py-6">
      ...
      <div className="relative mb-4 animate-fade-up">
        ...
        >
          ...
          <div className="absolute bottom-2 left-1/2 -translate-x-1/2 flex items-center gap-1" role="tablist" aria-label="Example images">
          ...
          <div className="absolute top-3 left-3">
            <span className="rounded-full bg-black/60 backdrop-blur-sm px-3 py-1 text-xs font-medium text-white">
      ...
      <div className="space-y-2.5 animate-fade-up delay-200">
        <button
          ...
          className="w-full rounded-xl py-4 text-sm font-semibold text-[var(--background)] transition-all hover:brightness-110 active:scale-[0.98]"
