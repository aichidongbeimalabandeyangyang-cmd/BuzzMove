    ...
    >
      <div className="relative w-full max-w-sm mx-4 animate-scale-in">
        ...
        <div className="relative rounded-2xl border border-[var(--border)] bg-[var(--card)] p-7 shadow-2xl">
          ...
          {/* Header */}
          <div className="mb-7">
            <div className="mb-4 flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-[var(--primary)] to-[var(--accent)]">
              <svg
          ...
          {sent ? (
            ...
            <>
              ...
              <button
                ...
                className="mb-4 flex w-full items-center justify-center gap-2.5 rounded-xl border border-[var(--border)] bg-white px-4 py-3 text-sm font-medium text-black transition-all hover:bg-gray-50 hover:shadow-sm active:scale-[0.98]"
              >
